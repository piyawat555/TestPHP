                        ...
                        <div class="row justify-content-between align-items-center">
                            ...
                            <div class="app-utilities col-auto">
                                <div class="app-utility-item app-user-dropdown dropdown">
                                    <a class="dropdown-toggle" id="user-dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-expanded="false"><img src="assets/assets/images/user1.jpg" alt="user profile" /> username</a>
            ...
            <div id="app-sidepanel" class="app-sidepanel">
                ...
                <div class="sidepanel-inner d-flex flex-column">
                    ...
                    <div class="app-branding">
                        <a class="app-logo" href="../admin/"><span class="logo-text">MycataLog</span></a>
                    </div>
                    <!--//app-branding-->
                        ...
                        <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                            ...
                            <li class="nav-item">
                                ...
                                <a class="nav-link <?php echo isset($_GET['page']) && $_GET['page'] == 'about' ? 'active' : '' ?>"  href="?page=about">
                                    ...
                                    <span class="nav-link-text">ข้อมูลของฉัน</span>
                                </a>
                                <!--//nav-link-->
                            </li>
                            ...
                            <li class="nav-item has-submenu">                               
                                ...
                                <span class="nav-icon">
                                    ...
                                    <span class="nav-link-text">จัดการสินค้า</span>
                                 
                                </a>
                             
                                <div id="submenu-1" class="collapse submenu submenu-1" data-parent="#menu-accordion">
                                    <ul class="submenu-list list-unstyled">
                                        <li class="submenu-item"><a class="submenu-link <?php echo isset($_GET['page']) && $_GET['page'] == 'product' ? 'active' : '' ?>" href="?page=product">ข้อมูลสินค้า</a></li>
                                        <li class="submenu-item"><a class="submenu-link <?php echo isset($_GET['page']) && $_GET['page'] == 'producttype' ? 'active' : '' ?>" href="?page=producttype">ประเภทสินค้า</a></li>
                            ...
                            <li class="nav-item">
                                ...
                                <a class="nav-link <?php echo isset($_GET['page']) && $_GET['page'] == 'admin' ? 'active' : '' ?>" href="?page=admin">
                                    <span class="nav-icon">
                                       <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" class="bi bi-file-person-fill" viewBox="0 0 16 16">
                                            <path d="M12 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2zm-1 7a3 3 0 1 1-6 0 3 3 0 0 1 6 0zm-3 4c2.623 0 4.146.826 5 1.755V14a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1v-1.245C3.854 11.825 5.377 11 8 11z"/>
                                            </svg>
                                    </span>
                                    <span class="nav-link-text">จัดการผู้ดูแลระบบ</span>
                                </a>
                                <!--//nav-link-->
                            </li>
                            <!--//nav-item-->
